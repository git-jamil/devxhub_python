...
.. code-block:: JSON

    {
        "project_slug": "sample",
        "_copy_without_render": [
            "{{devxhub_python.repo_name}}/templates/*.html",
        ]
    }

In this example, ``{{devxhub_python.repo_name}}`` will be rendered as expected but the html file content will be copied without rendering.
